...
DROP TABLE IF EXISTS test.team_admins CASCADE;
DROP TABLE IF EXISTS test.team_members CASCADE;
DROP TABLE IF EXISTS test.teams CASCADE;
DROP TABLE IF EXISTS test.admins CASCADE;
...
-- make admins table, a subclass of users
...
-- make team admins table, a join table between admins and teams
CREATE TABLE IF NOT EXISTS test.team_admins (
	id SERIAL PRIMARY KEY,
	team_id INTEGER NOT NULL REFERENCES test.teams(id),
	admin_id INTEGER NOT NULL REFERENCES test.admins(id),
	joined_on DATE NOT NULL DEFAULT '-infinity'
);
...
-- make test admins
INSERT INTO test.admins (user_id) VALUES (1);
INSERT INTO test.admins (user_id) VALUES (4);
...
INSERT INTO test.team_members (team_id, user_id) VALUES (1, 1);
INSERT INTO test.team_members (team_id, user_id) VALUES (1, 2);
INSERT INTO test.team_members (team_id, user_id) VALUES (1, 3);
INSERT INTO test.team_members (team_id, user_id) VALUES (1, 4);
INSERT INTO test.team_members (team_id, user_id) VALUES (2, 1);
INSERT INTO test.team_members (team_id, user_id) VALUES (2, 4);

-- make test team admins
INSERT INTO test.team_admins (team_id, admin_id) VALUES (1, 1);
INSERT INTO test.team_admins (team_id, admin_id) VALUES (1, 2);
INSERT INTO test.team_admins (team_id, admin_id) VALUES (2, 1);
INSERT INTO test.team_admins (team_id, admin_id) VALUES (2, 2);
